        ...
        try {
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = '𝙳𝚄𝙻𝙰𝙽𝚃𝙷𝙰-𝙼𝙳=' + stringSession;  // Prepend your name to the session ID
                    ...
                    await SUPUNMDInc.sendMessage(userJid, { text: "𝗗𝗨𝗟𝗔𝗡𝗧𝗛𝗔 𝗠𝗗 𝗦𝗘𝗦𝗦𝗜𝗢𝗡 𝗦𝗨𝗖𝗖𝗘𝗦𝗙𝗨𝗟𝗟👇*\n\n*⭕ WHATSAPP CHANNEL :*\n\n> https://whatsapp.com/channel/0029Vb5gDt17T8bSSIRzZS27\n\n*⭕Contact Owner :*\n\n> wa.me/94774860151\n\n\n🚫 *𝗗𝗢𝗡𝗧 𝗦𝗛𝗔𝗥𝗘 𝗬𝗢𝗨𝗥 𝗦𝗘𝗦𝗦𝗜𝗢𝗡 𝗜𝗗* 🚫" });
